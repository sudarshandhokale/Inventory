...
class StoreItemsControllerTest < ActionController::TestCase
  ...
  test "should update store_item" do
    patch :update, id: @store_item, store_item: { name: @store_item.name, price: @store_item.price, quantity: @store_item.quantity, store_category_id: @store_item.store_category_id, store_id: @store_item.store_id, store_type_id: @store_item.store_type_id, tax: @store_item.tax }
    assert_redirected_to store_item_path(assigns(:store_item))
  end
